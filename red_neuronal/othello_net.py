...
"""Por ultimo, converitmos esos 64 primeros valores de cada fila a (N, 8, 8) donde N es el número de filas del csv y 8x8 el 
tamaño del tablero"""
...
def convertir_a_canales(x_tablero): #Entrada de tablero con valores 0, 1 o 2.
    """
   Para ello tomamos el numero de filas N del tablero cocnreto y creamos una matriz de ceros de tamaño (N, 8, 8, 2).
    ...
    return X_can #Salida de tablero en canales [0/1, 0/1].
